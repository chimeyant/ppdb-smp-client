  ...
  <div class="home pa-6">
    ...
    <v-flex class="pb-5 pl-7">
      <div class="grey--text mb-2">
        Daftar Seluruh Petugas Yang Tersedia
      </div>
    </v-flex>
        ...
        <v-card>
          <v-card-title class="flex flex-row-reverse">
            <v-tooltip color="blue" bottom>
              <template v-slot:activator="{ on }">
                <v-btn text small icon v-on="on">
                  <v-icon color="blue" @click="addNewRecord">add</v-icon>
                </v-btn>
              </template>
            ...
            <v-tooltip color="green" bottom>
              <template v-slot:activator="{ on }">
                <v-btn text small icon v-on="on">
                  <v-icon color="green" @click="fetchRecords">refresh</v-icon>
                </v-btn>
              </template>
    ...
    <v-col col="12">
      ...
      >
        <v-card>
          <v-toolbar :color="theme" dark>Formulir Petugas</v-toolbar>
          <v-card-title class="justify-center">DATA PETUGAS</v-card-title>
          <v-card-text>
            <v-col col="12">
              <v-text-field
                outlined
...
export default {
  ...
  data: () => ({
    ...
    jenis: [
      { text: "INSPEKTUR", value: "inspektur" },
      { text: "PENDAMPING TEKNIS", value: "pendamping-teknis" },
    ],
  }),
  computed: {
    ...mapState([
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/master-data-penera",
    });
    this.fetchRecords();
  },
  mounted() {},
