  ...
  <div class="home pa-6">
    ...
    >
      ...
      <v-subheader class="text-h6">
        <h4>MANAJEMEN PARAMETER PENILAIAN</h4>
      </v-subheader>
    </v-flex>
    <v-flex class="pb-5 pl-7">
      <div class="grey--text mb-2">
        Daftar Seluruh Parameter Penilaian Yang Tersedia
      </div>
    </v-flex>
      ...
      >
        <v-card>
          <v-toolbar
            :color="theme"
            dark
          >Formulir Parameter Nilai</v-toolbar>
          <v-card-title class="justify-center">DATA PARAMETER</v-card-title>
          <v-card-text>
            <v-col col="12">
              <v-text-field
                outlined
