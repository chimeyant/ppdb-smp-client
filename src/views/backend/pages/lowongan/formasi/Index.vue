<template>
  <div class="home pa-6">
    <v-flex row class="pb-2">
      <v-icon :color="theme">hail</v-icon>
      <v-subheader class="text-h6">
        <h4>MANAJEMEN LOWONGAN FORMASI</h4>
      </v-subheader>
    </v-flex>
    <v-flex class="pb-5 pl-7">
      <div class="grey--text mb-2">
        Daftar Seluruh Lowongan Formasi Yang Tersedia
      </div>
    </v-flex>
      ...
      >
        <v-card>
          ...
          <v-card-text>
            ...
            <v-col col="12">
              <v-textarea
                label="Keterangan Pekerjaan (Job Desc)"
                :color="theme"
...
export default {
  ...
  methods: {
    ...
    fetchSkpd2: async function() {
      let { data: data } = await this.http.post("api/skpd2-combo", this.record);
      this.skpd2s = data;
    },

    fetchSkpd3: async function() {
      let { data: data } = await this.http.post("api/skpd3-combo", this.record);
      this.skpd3s = data;
    },
  ...
  watch: {
    ...
    "record.skpd2_id": function() {
      this.fetchSkpd3();
    },
    "record.skpd3_id": function() {
      this.fetchUnkers();
    },
