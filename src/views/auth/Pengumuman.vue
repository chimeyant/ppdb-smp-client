        ...
        >
          ...
          >
            <div class="text-xs-center text-center">
              <h2 class="headline">PENGUMUAN PPDB 2021/2022</h2>
              <span class="subheading">
                Dengan Rahmat Tuhan Yang Maha Esa, berikut penetapan hasil
                seleksi Penerimaan Peserta Didik Baru (PPDB) yang di terima di
                {{ info.company }} Tahun Pelajaran 2021-2022 :
              </span>
            </div>
          </v-flex>
          <v-flex xs12>
